...
def test_ticker_validation(user_input):
    print(f"\n{'='*80}")
...
if __name__ == "__main__":
    test_cases = [
        "I want to backtest buying Apple when the 50-day moving average crosses above the 200-day moving average, and selling when it crosses below.",
        "Create a strategy for INVALIDTICKER using RSI oversold conditions",  # Invalid ticker test
        "Test Microsoft with bollinger bands",
    ]
    
    for test_case in test_cases:
        test_ticker_validation(test_case)
        print("\n" + "="*100 + "\n")